...
var abtUsSec = ' <div class="fluid-container binHide" id="abtUsSection" data-sec="index-banner"><div class="section"><div class="row"><div class="col s12 center"><h3><i class="mdi-content-send brown-text"></i></h3><img src="assets/img/about.png" style="width: 700px"></div></div></div><div class="parallax-container valign-wrapper"><div class="section no-pad-bot"><div class="container"><div class="row center"></div></div></div></div></div>';
